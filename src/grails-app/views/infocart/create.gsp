    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form action="save" method="post" >
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="name"><g:message code="infocart.name.label" default="Name" /></label>
                                </td>
                ...
                <div class="buttons">
                    <span class="button"><g:submitButton name="create" class="save" value="${message(code: 'infocart.button.create.label', default: 'Create')}" /></span>
                </div>
            </g:form>
        </div>
    </body>
