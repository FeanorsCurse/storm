...
<head>
  ...
  <title><g:message code="link.text.archiv-reports" default="Sustainability Reports" /></title>
</head>
<body>
  <h1><g:message code="link.text.archiv-reports" default="Sustainability Reports" /></h1>
