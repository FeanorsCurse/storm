                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="activated"><g:message code="template.activated.label" default="Activated" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: templateInstance, field: 'activated', 'errors')}">
                                    <g:checkBox name="activated" value="${templateInstance?.activated}" />
                                </td>
                            </tr>
