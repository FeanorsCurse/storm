            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="template.activated.label" default="Activated" /></td>
                            
                            <td valign="top" class="value"><g:formatBoolean boolean="${templateInstance?.activated}" /></td>
