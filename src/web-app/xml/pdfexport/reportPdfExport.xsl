...
<xsl:stylesheet version="1.0"
			...
			<fo:page-sequence master-reference="Deckblatt">
				<fo:flow flow-name="xsl-region-body">
					<fo:block font-size="24pt" font-family="sans-serif"
						...
						margin-top="160pt" padding-top="15pt" text-align="center"
						margin-bottom="100pt">
				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block color="blue" margin-bottom="100pt">
						<fo:list-block line-height="1.5em" font-size="12pt"
							...
							<xsl:for-each select="data/articleList/article">
								<fo:list-item>
	...
	<xsl:template match="data">
		...
		<xsl:for-each select="articleList/article">

			<fo:block id="{name}" font-size="12pt" font-family="sans-serif"
