...
var oldWidth, oldHeight, ed, url, stringFLV;
...
function insertMedia() {
	...
	if (fe != null && /mceItem(Flash|FlashVideo|ShockWave|WindowsMedia|QuickTime|RealMedia)/.test(ed.dom.getAttrib(fe, 'class'))) {
		...
		h = '<p>Debug: something went wrong ...</p><img src="' + tinyMCEPopup.getWindowArg("plugin_url") + '/img/trans.gif"' ;
		//h = stringFLV;
...
function generatePreview(c) {
	var f = document.forms[0], p = document.getElementById('prev'), h = '', cls, pl, n, type, codebase, wp, hp, nw, nh, isFLV;
	isFLV = false;
	...
	switch (f.media_type.options[f.media_type.selectedIndex].value) {
		...
		case "flv": //added by Olaf
			isFLV = true;
			string1 = '<p>Preview Test </p>\n';
			string2 = '<script type="text/javascript" src="http://localhost:8080/Storm/js/flvplayer/flvplayer-1.9.7b/flvplayer/swfobject.js"></script>\n';
			string3 = '<script type="text/javascript">\n';
			string4 = 'var playervars = false;\n';
			string5 = 'swfobject.embedSWF('
			+'"http://localhost:8080/Storm/js/flvplayer/flvplayer-1.9.7b/flvplayer/flvplayer.swf'
			+'?contentpath=http://localhost:8080/Storm/Mediathek/admin'
			+'&preview='
			+'&video=flashtest.flv'
			+'&captions='
			+'&preroll='
			...
			+'&ending='
			+'&debug=",'
			+' "videoPreview", "640", "530", "9.0.28", "expressInstall.swf", playervars,'
			+' { scale: "noscale", allowfullscreen: "true",salign: "tl", bgcolor: "#FFFFFF", base: "."},'
			+' { align: "left"});';
			string6 = '</script>\n';
			string7 = '<span id="videoPreview" style="visibility:visible">\n';
			string8 = '<p>This <a href="http://www.video-flash.de/flv-flash-fullscreen-video-player/">Flash Video Player</a> requires the Adobe Flash Player.</p>\n';
			string9 = '<p><a href="http://www.adobe.com/go/getflashplayer" target="_blank">\n';
			string10 = '<img src="http://www.adobe.com/images/shared/download_buttons/get_flash_player.gif" alt="Get Adobe Flash player" /></a></p>\n';
			string11 = '</span>\n';
			string12 = '<p>Preview Test Ende</p>\n';
			stringFLV = string3+string4+string5+string6+string7+string8+string9+string10+string11;
			cls = 'clsid:D27CDB6E-AE6D-11cf-96B8-444553540000';
	...
	//added by Olaf
	if (isFLV){
		p.innerHTML = stringFLV;
		p.innerHTML = 'no preview for your mediatype available';
		return;
	}
